...
<body>
    ...
    <div class="container mt-3 p-3 rounded" style="background-color: #e9ecef;">  
      <h3>Remover Grupo</h3>
      <form id="remove_cmd" class="row g-3 needs-validation"  novalidate method="POST" action="code/del_cmd.php">
          <label for="select_cmd">Seleciona o comando a eliminar</label>
          <select name="select_cmd" id="select_cmd" class="form-select">
              <option selected disabled value="">Escolhe...</option>
          </select>
          <input type="submit" id="sub_rem_cmd" class="btn btn-primary" value="Submeter">
      </form>
    </div>
    <!--Footer-->
    ...
    <script src="js/rem_cmd.js"></script>
</body>
</html>