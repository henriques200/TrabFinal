...
<body>
    ...
    <div class="container mt-3 p-3 rounded" style="background-color: #e9ecef;">  
        <h3>Remover Grupo</h3>
        <form id="remove_group" class="row g-3 needs-validation"  novalidate method="POST" action="code/del_group.php">
            <label for="select_group">Seleciona o grupo a eliminar</label>
            <select name="select_group" id="select_group" class="form-select">
                <option selected disabled value="">Escolhe...</option>
            </select>
            <input type="submit" id="sub_rem_group" class="btn btn-primary" value="Submeter">
        </form>
    </div>
    <!--Footer-->
    ...
    <script src="js/rem_group.js"></script>
</body>
</html>