...
<body>
    ...
    <div class="container mt-3 p-3 rounded" style="background-color: #e9ecef;">  
        ...
        <form id="run_command" novalidate method="POST" action="code/run_cmd.php">
            ...
            <label for="opt_cmd">Escolhe o equipamento</label>
            <select id="opt_cmd" name="opt_cmd" class="form-select">
                <option selected disabled>Escolhe...</option>
            </select>
            <br>
            <button type="submit" id="submit_run_cmd" class="btn btn-primary">Executar comando</button>
          </form>
    </div>
    <!--Footer-->
    ...
    <script src="js/execute_cmd.js"></script>
</body>
</html>